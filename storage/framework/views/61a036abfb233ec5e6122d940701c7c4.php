    ...
    <div class="container-fluid">
      ...
      <div class="container mt-5">
        ...
        <div class="row justify-content-center">
            ...
            ?>
            <?php if($juaraCounter < 3): ?> <!-- Hanya menampilkan tiga juara -->
            <div class="col-md-4 <?php echo e($program); ?>">
                <h6 class="text-success">Juara <?php echo e(++$juaraCounter); ?></h6>
                <div class="card">
                    <div class="card-body">
                        <img src="<?php echo e(asset('storage/' . $siswa->photo)); ?>" alt="Gambar Juara <?php echo e($juaraCounter); ?>" width="50px" class="rounded">
                        <p class="card-text"><?php echo e($siswa->nama); ?></p>
                        <p class="card-text">
                            <?php if($program === 'Flutter'): ?>
                            <i class="fab fa-android text-success"></i> Flutter <i class="fab fa-android text-success"></i>
                            <?php elseif($program === 'Kotlin'): ?>
                            <i class="fas fa-robot text-success"></i> Kotlin <i class="fas fa-robot text-success"></i>
                            <?php elseif($program === 'UI Design'): ?>
                            <i class="fas fa-paint-brush text-success"></i> UI Design <i class="fas fa-paint-brush text-success"></i>
                            <?php elseif($program === 'Web Developer'): ?>
                        ...
                        <p class="card-text">Batch <?php echo e($siswa->angkatan); ?></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                  ...
                  <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                      ...
                      <iframe width="100%" height="500" src="<?php echo e($siswa->portofolio); ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                      <?php else: ?>
                      Portofolio belum ditambahkan.
                      <?php endif; ?>
                      <div class="carousel-caption d-none d-md-block">
                          Nama: <?php echo e($siswa->nama); ?> | Batch <?php echo e($siswa->angkatan); ?> |
...
<script>
  $(document).ready(function() {
      var siswaData = <?php echo json_encode($siswas, 15, 512) ?>;
                  ...
                  <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                          <div class="card testimonial-card text-white">
                              ...
                              <div class="card-body">
                                  <p class="card-text text-center"><?php echo e($review->nama); ?></p>
                                  <p class="card-text text-center"><?php echo e($review->review); ?></p>
                              </div>
                              <div class="text-center mb-3">
                                Batch <?php echo e($review->angkatan); ?> |
...
<script>
  $(document).ready(function() {
      var reviewData = <?php echo json_encode($reviews, 15, 512) ?>;
      var currentSlideIndex = 0;
...
<?php /**PATH D:\UdaCoding\Codingan\mentoring\mentoring\resources\views/home.blade.php ENDPATH**/ ?>